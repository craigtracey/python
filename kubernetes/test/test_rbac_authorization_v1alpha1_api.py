...
from client.apis.rbac_authorization_v1alpha1_api import RbacAuthorizationV1alpha1Api
...
class TestRbacAuthorizationV1alpha1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = client.apis.rbac_authorization_v1alpha1_api.RbacAuthorizationV1alpha1Api()
