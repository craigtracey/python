...
from client.models.v1beta1_json_schema_props_or_string_array import V1beta1JSONSchemaPropsOrStringArray
...
class TestV1beta1JSONSchemaPropsOrStringArray(unittest.TestCase):
    ...
    def testV1beta1JSONSchemaPropsOrStringArray(self):
        ...
        #model = client.models.v1beta1_json_schema_props_or_string_array.V1beta1JSONSchemaPropsOrStringArray()
        pass
