...
from client.apis.admissionregistration_v1alpha1_api import AdmissionregistrationV1alpha1Api
...
class TestAdmissionregistrationV1alpha1Api(unittest.TestCase):
    ...
    def setUp(self):
        self.api = client.apis.admissionregistration_v1alpha1_api.AdmissionregistrationV1alpha1Api()
